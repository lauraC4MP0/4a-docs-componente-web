  ...
  <br>
        ...
        <div class="signup-container">
          <form action="" class="form-signup" v-on:submit.prevent="processSingUp">
            ...
            <input id="signup-input-id" class="signup__input" type="text" v-model="user.id"/>
            <label for="signup-input-name" class="signup__label">
              Username
            </label>
            <input id="signup-input-name" class="signup__input" type="text" v-model="user.username"/>
            <label for="signup-input-password" class="signup__label">
              Contraseña
            </label>
            <input id="signup-input-password" class="signup__input" type="password" v-model="user.password"/>
            <label for="signup-input-password2" class="signup__label">
              Confirma tu contraseña
            </label>
            <input id="signup-input-password2" class="signup__input" type="password" />
            <label for="signup-input-name" class="signup__label">
              Nombres
            </label>
            <input id="signup-input-name" class="signup__input" type="text" v-model="user.name" />
            <label for="signup-input-lastname" class="signup__label">
              Apellidos
            </label>
            <input id="signup-input-lastname" class="signup__input" type="text" v-model="user.lastname" />
            <label for="signup-input-user" class="signup__label">
              email
            </label>
            <input id="signup-input-email" class="signup__input" type="email" v-model="user.email" />
            <label for="signup-sign-up" class="signup__label--checkbox">
              <input id="signup-sign-up" type="checkbox" class="signup__input--checkbox" >
              Quiero recibir notificaciones a mi correo
            </label>
            <button class="signup__submit"  type="submit" id="signup" >Registrarse</button>
          </form>
		...
		processSingUp:function(){
			...
			if(validation){
				await this.$apollo.mutate({
					mutation:gql`mutation Mutation($userInput: SignUpInput) {
					...
					let dataSignUp={
						id:this.result.id,
						resultname:this.result.username,
