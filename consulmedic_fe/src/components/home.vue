<template>
  <div>
    <div class="welcome">
      <h1>BIENVENIDO A CONSULMEDIC: {{ idUser }}</h1>
    </div>
    <div class="home">
      ...
      <div class="buttons1">
        <a v-on="is_auth"
          ><router-link to="/user/newPatient"></router-link
          ><input type="button" value="Crear Paciente"
        /></a>
        <br />
        <br />
        <a v-on="is_auth"
          ><router-link to="/user/UpdatePatient"></router-link
          ><input type="button" value="Actualizar Paciente"
        /></a>
        <br />
        <br />
        <a v-on="is_auth"
          ><router-link to="/user/reportEvolution"></router-link
          ><input type="button" value="Crear Reporte de evolución"
        /></a>
        <br />
        <br />
        <a v-on="is_auth"
          ><router-link to="/user/historicReport"></router-link
          ><input type="button" value="Consulta reportes por paciente"
        /></a>
      </div>
    </div>
  </div>
